...
def get_baseline_df(df):
    ...
    mapping = pd.read_csv('/gpfs/work1/0/prjs1425/shark/clinical_features/patid_xnat_lut_20250307.csv')
    ...
    inclusion = pd.read_csv('/gpfs/work1/0/prjs1425/shark/preprocessing/modality/included_images_app.csv')
